...
**********com1**********
**********prcp-ENSO removed June*****************
'set vpage 0 8.5 0 10.5'
'set parea 0.5 4.0 8.0 10.0'
'open ../11_10_composite_prcp_ENSO_removed_June/com_diff_prcp.ctl'
'set grads off'
'set lon 40 160'
'set lat -5 35'
'set grid off'
...
'set clevs -2.764 -1.81 1.81 2.764'
'set xlab on'
'set ylab on'
'set frame on'
'd com(z=2)*(-1)'
...
**********PRCP-ENSO removed July*****************
'set vpage 0 8.5 0 10.5'
'set parea 0.5 4.0 6.0 8.0'
'open ../11_10_composite_prcp_ENSO_removed/com_diff_prcp.ctl'
'set grads off'
'set lon 40 160'
'set lat -5 35'
'set xlint 40'
...
**********PRCP-ENSO removed September**************
'set vpage 0 8.5 0 10.5'
'set parea 0.5 4.0 2.0 4.0'
'open ../11_10_composite_prcp_ENSO_removed_September/com_diff_prcp.ctl'
'set grads off'
'set lon 40 160'
'set lat -5 35'
'set xlint 40'
...
**********com2**********
**********HGT850-ENSO removed June*****************
'set vpage 0 8.5 0 10.5'
'set parea 4.3 7.8 8.0 10.0'
'open ../11_01_composite_HGT_ENSO_removed_June/com_diff_prcp.ctl'
'set grads off'
'set lon 40 160'
'set lat -5 35'
'set grid off'
...
**draw wind*
'open ../11_03_composite_uwnd_ENSO_removed_June/com_diff_prcp.ctl'
'open ../11_04_composite_vwnd_ENSO_removed_June/com_diff_prcp.ctl'
...
'set ccolor 15'
'set arrscl 0.5 6'
'd skip(com.1(z=1),2,2)*(-1);skip(com.2(z=1),2,2)*(-1)'

'b = abs(com.1(z=2))+abs(com.2(z=2)) - 2.74'
...
'open ../11_01_composite_HGT_ENSO_removed/com_diff_prcp.ctl'
'set grads off'
'set lon 40 160'
'set lat -5 35'
'set xlint 40'
...
**draw wind*
'open ../11_03_composite_uwnd_ENSO_removed/com_diff_prcp.ctl'
'open ../11_04_composite_vwnd_ENSO_removed/com_diff_prcp.ctl'
...
**draw wind*
'open ../11_03_composite_uwnd_ENSO_removed_August/com_diff_prcp.ctl'
'open ../11_04_composite_vwnd_ENSO_removed_August/com_diff_prcp.ctl'
...
**********HGT850-ENSO removed September************
'set vpage 0 8.5 0 10.5'
'set parea 4.3 7.8 2.0 4.0'
*'open ../11_01_composite_HGT/com_n_prcp.ctl'
*'open ../11_01_composite_HGT_ENSO_removed/com_n_prcp.ctl'
'open ../11_01_composite_HGT_ENSO_removed_September/com_diff_prcp.ctl'
'set grads off'
'set lon 40 160'
'set lat -5 35'
'set xlint 40'
...
**draw wind*
'open ../11_03_composite_uwnd_ENSO_removed_September/com_diff_prcp.ctl'
'open ../11_04_composite_vwnd_ENSO_removed_September/com_diff_prcp.ctl'

'set lon 40 160'
'set lat -5 35'

'set arrscl 0.5 6'
*rc = arrow(3.75,2.00,0.5,6)
rc = arrow(7.5,2.00,0.5,6)
'set arrlab off'
...
*'set vpage 0 8.5 0 10.5'
*'set parea 0.5 4.0 2.0 4.0'
*'open ../11_03_composite_uwnd/com_diff_prcp.ctl'
*'open ../11_04_composite_vwnd/com_diff_prcp.ctl'
...
'draw string 0.45 9.80  (a) PRCP in Jun. (ENSO removed)'
'draw string 0.45 7.80  (c) PRCP in Jul. (ENSO removed)'
'draw string 0.45 5.80  (e) PRCP in Aug. (ENSO removed)'
'draw string 0.45 3.80  (g) PRCP in Sep. (ENSO removed)'

*'draw string 4.25 9.80  (e) Precipitation-Group Blue'
'draw string 4.25 9.80  (b) HGT850 (ENSO removed)'
'draw string 4.25 7.80  (d) HGT850 (ENSO removed)'
'draw string 4.25 5.80  (f) HGT850 (ENSO removed)'
'draw string 4.25 3.80  (h) HGT850 (ENSO removed)'
...
'gxprint test_ENSO_removed_for_all_month.png white'
