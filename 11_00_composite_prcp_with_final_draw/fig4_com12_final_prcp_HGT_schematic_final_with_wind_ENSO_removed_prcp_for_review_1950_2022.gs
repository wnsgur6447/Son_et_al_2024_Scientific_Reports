...
'open ../11_01_composite_HGT/com_p_prcp_1950_2022.ctl'
...
'open ../11_01_composite_HGT/com_n_prcp_1950_2022.ctl'
...
'open ../11_03_composite_uwnd/com_p_prcp_1950_2022.ctl'
'open ../11_04_composite_vwnd/com_p_prcp_1950_2022.ctl'
'open ../11_03_composite_uwnd/com_n_prcp_1950_2022.ctl'
'open ../11_04_composite_vwnd/com_n_prcp_1950_2022.ctl'
...
'set arrscl 0.5 2'
rc = arrow(3.75,2.00,0.5,2)
rc = arrow(7.5,2.00,0.5,2)
'set arrlab off'

'set ccolor 15'
'set arrscl 0.5 2'
'd skip(com.1(z=1),2,2);skip(com.2(z=1),2,2)'

'b = abs(com.1(z=2))+abs(com.2(z=2)) - 1.74'
...
'set ccolor 15'
'set arrscl 0.5 2'
'd skip(com.3(z=1),2,2);skip(com.4(z=1),2,2)'

'b = abs(com.3(z=2))+abs(com.4(z=2)) - 1.74'
...
'draw string 0.45 3.80  (g) Wind925'
...
'draw string 4.25 3.80  (h) Wind925'
...
'gxprint test_1950_2022.png white'
