...
print(os.system('ncdump -c /data2/jhson/climate_indices/program/00_make_nc/NINO3.4.nc'))
...
data = vel_pot.reshape(43,12,73,144)
...
index_temp = np.zeros((20),dtype=float)
nino_temp = np.zeros((20),dtype=float)
temp_num = 0
...
plt.plot(back_x,back_y+0.5,':',color='gray',linewidth=2)
plt.plot(back_x,back_y-0.5,':',color='gray',linewidth=2)
