...
'draw string 0.45 5.80  (e) HGT850 (ENSO signal removed)'
'draw string 0.45 3.80  (g) Wind925 (ENSO signal removed)'
...
'draw string 4.25 5.80  (f) HGT850 (ENSO signal removed)'
'draw string 4.25 3.80  (h) Wind925 (ENSO signal removed)'
...
'gxprint test_ENSO_removed_for_all.png white'
